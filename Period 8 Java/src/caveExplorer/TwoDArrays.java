...
//		startExploring();
	...
	private static int[] interpretInput(String input) {
		...
		while(!isValid(input)){
			System.out.println("Sorry, in this game, you can pnmly use the w, a, s, and d controls");
	...
	private static String countNearby(boolean[][] mines, int row, int col) {
		//one way to avoid ArrayIndexOutOfBoundsException
...
//		return ""+count;
		...
		//for example, you only want elements in the North and East
		int count=0;
